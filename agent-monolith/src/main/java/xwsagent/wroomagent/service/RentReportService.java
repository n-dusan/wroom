...
public class RentReportService {
    ...
    public RentReportService(RentReportRepository rentReportRepository, RentsService rentsService, RentRequestRepository rentRequestRepository, UserService userService,
