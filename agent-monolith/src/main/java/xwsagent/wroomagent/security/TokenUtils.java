...
public class TokenUtils {
	...
	// Name of the header that will be used for client-server communication
	@Value("Authorization")
	private String AUTH_HEADER;

	// Different types of clients (in our case, use just WEB)
...
//		}
	...
	// Ignoring token expiration for mobile or tablet devices
