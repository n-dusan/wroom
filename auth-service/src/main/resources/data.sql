...
-- insert into users(id, email, enabled, name, non_locked, password, surname)
-- values (1, 'mila@maildrop.cc', 1, 'Mila', 1, '$2a$10$5EIPh4FLRCczl/.mnQhHP.8GmBJT2tL8kgBS1qDALVaybk6hh5o5.', 'Stojakovic');
